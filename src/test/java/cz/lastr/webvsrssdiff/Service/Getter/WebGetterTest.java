...
class WebGetterTest {
    ...
    public void testWebGetterGetArticlesFromWeb() throws IOException {
        WebArticleTempTable testArticle = new WebArticleTempTable(
                66783210,
        ...
        File testPage = new File("src/test/java/cz/lastr/webvsrssdiff/Service/Getter/resources/testPageArchiv.ihned.cz.html");
        ...
        assertTrue(articlesFromFeed.contains(testArticle));
    }
}